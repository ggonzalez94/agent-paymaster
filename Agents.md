...
- `ServoAccount.sol` — canonical single-owner ERC-4337 account with ERC-1271 permit validation and ERC-721 safe-receive support via OpenZeppelin `ERC721Holder`
